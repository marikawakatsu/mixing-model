...
\begin{figure}[H]
    ...
    \caption{Simulation results for the mixing of two groups differing in task efficiency ($\alpha$) and mean threshold ($\mu$). Groups could represent demographic (young/old) or morphological (workers/intercastes) classes. Parameters: $\alpha_j^{\C} = 2, \alpha_j^{\D} = 2.$}
...
\begin{figure}[H]
    ...
    \caption{Simulation results for the mixing of two groups differing in task efficiency ($\alpha$) and mean threshold ($\mu$). Parameters: $\alpha_j^{\A} = 2, \alpha_j^{\B} = 1.$}
