...
\vspace{-5pt}
%In addition to varying parameters by line (Section~\ref{sec:byline}) and task (Appendix~\ref{sec:bytask}) only,
%We have additionally tested two cases where parameters vary both by line and by task.\vspace{-10pt}
