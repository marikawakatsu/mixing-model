...
\subsection{\textit{Varying} by line and \textit{fixing} by task}\label{sec:byline}
...
\section{Additional results: \textit{varying} by line and \textit{fixing} by task}
