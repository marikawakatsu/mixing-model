...
Namely, we look for under what parameter settings in the fixed response threshold can result in two qualitative patterns observed in empirical mixing data:
\begin{itemize}
    \item Different behavioral means for task performance for each genetic line in isolation, and
    \item The convergence of behavioral means for each line when mixed with members of the other line (i.e., the appearance of a "social contagion").
\end{itemize}

\section{Plan}
\subsection{Original model in Ulrich et al. \cite{ulrich2018}}

We play with parameters using the model as in Ulrich et. al \cite{ulrich2018} as our base model. Parameters will take the values as used in that model unless they are explicitly changed by us. 
...
Here we assume that the two lines differ in some trait (e.g., threshold mean), but do not differ between tasks within a line. In other words, individuals of a given line do not "treat" tasks differently, but individuals of different lines inherently differ in some way. 
...
Here we assume that the two lines are essentially identical, but that individuals treat tasks differently in some way. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_6.00_6.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_20.00_20.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_AThreshSD_0.10_0.10_BThreshM_10.00_10.00_BThreshSD_0.30_0.30_deltas_0.60_0.60_threshSlope_7_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{Diff_Etas_HighB.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_AThreshSD_0.10_0.10_BThreshM_10.00_10.00_BThreshSD_0.10_0.10_deltas_0.60_0.60_threshSlope_7_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20_0.60}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_6.00_Balpha_2.00_6.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_20.00_BThreshM_10.00_20.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_AThreshSD_0.10_0.30_BThreshM_10.00_10.00_BThreshSD_0.10_0.30_deltas_0.60_0.60_threshSlope_7_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_1.80_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_1.80_1.80_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_6.00_Balpha_6.00_2.00_quitP_0.20}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\linewidth]{{AThreshM_10.00_20.00_BThreshM_20.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
	\caption{Higher task demand rate ($\delta$) for both tasks compared to the base case, with $\mu^A_1 = 10,\ \mu^A_2 = 20,\ \mu^B_1 = 20,\ \mu^B_2 = 10$. \\\hspace{0pt}\\
%\textbf{Interpretation}: 
}
