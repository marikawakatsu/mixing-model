...
\begin{figure}[H]
	\centering
	\includegraphics[width=.75\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
...
\subsubsection{Varying task performance efficiency $\alpha$}

\begin{figure}[H]
	\centering
	\includegraphics[width=.75\linewidth]{{AThreshM_10.00_10.00_BThreshM_10.00_10.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_6.00_6.00_quitP_0.20}.png}
...
\subsubsection{Varying mean threshold $\mu$}

\begin{figure}[H]
	\centering
	\includegraphics[width=.75\linewidth]{{AThreshM_10.00_10.00_BThreshM_20.00_20.00_deltas_0.60_0.60_threshSlope_7_Aalpha_2.00_2.00_Balpha_2.00_2.00_quitP_0.20}.png}
	\caption{Varying task performance efficiency ($\alpha$) by line. The parameter values are identical to those in the base case (Fig.~\ref{fig:base}) with the exception of line-specific efficiencies, $\alpha^A = 2, \alpha^B = 6$. \\\hspace{0pt}\\
...
\subsubsection{Varying threshold variance $\sigma$}

\subsubsection{Varying threshold stochasticity $\eta$}

\subsubsection{Varying quit probability $\tau$}
