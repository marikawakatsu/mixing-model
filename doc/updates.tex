...
\begin{figure}[H]
    \centering
    \includegraphics[trim={0 0.25in 0 0.2in}, clip, width=1\linewidth]{output/Task_dist/5050_comparison.pdf}
    \caption{Test}
    \label{fig:5050comp}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{output/Task_dist/mixes_comparison.pdf}
    \caption{To be replaced with Chris's new figure}
    \label{fig:mixescomp}
\end{figure}
