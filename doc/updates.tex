...
\begin{figure}[H]
    ...
    \caption{Simulation results for varying both the demand rate ($\delta$) and the task efficiency ($\alpha$) when line \B\ is highly efficient. Parameters: $\alpha_{j}^{\A}  = 2$, $\alpha_{j}^{\B} = 6$, $\sigma = 0.1$, $\mu = 10$, $\eta = 7$.}
...
\begin{figure}[H]
    ...
    \caption{Simulation results for varying both the demand rate ($\delta$) and the task efficiency ($\alpha$) when line \B\ is inefficient. Parameters: $\alpha_{j}^{\A}  = 2$, $\alpha_{j}^{\B} = 1$, $\sigma = 0.1$, $\mu = 10$, $\eta = 7$.}
