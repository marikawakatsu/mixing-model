...
\begin{figure}[H]
    \centering
    \includegraphics[trim={0 1.25in 0 1.1in}, clip, width=0.95\linewidth]{{doc/deltas_comparison_superefficient}.pdf}
    \caption{Simulation results when both the demand rate ($\delta$) and the task efficiency ($\alpha$) are varied. Parameters: $\alpha_{j}^{\A}  = 2$, $\alpha_{j}^{\B} = 6$, $\sigma = 0.1$, $\mu = 10$, $\eta = 7$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim={0 1.25in 0 1.1in}, clip, width=0.95\linewidth]{{doc/deltas_comparison_inefficient}.pdf}
    \caption{Caption}
