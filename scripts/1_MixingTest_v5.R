...
for (INDEX in 1:nrow(params)){
  ...
  mixes          <- c("A", "B", "AB")
  A_ThreshM      <- c(params[INDEX,1], params[INDEX,2]) #population threshold means for clone line A !!Change!!
  A_ThreshSD     <- A_ThreshM * c(params[INDEX,5], params[INDEX,6]) #population threshold standard deviations for clone line A !!Change!!
  B_ThreshM      <- c(params[INDEX,3], params[INDEX,4]) #population threshold means for clone line B !!Change!!
  B_ThreshSD     <- B_ThreshM * c(params[INDEX,7], params[INDEX,8]) #population threshold standard deviations for clone line B !!Change!!
